package com.rightname.asthmaapp.utils
...
object DateUtil {
    ...
    fun takeMedicamentCheckingEnableSaveButton(
        medicamentNameEditText: TextInputEditText,
        medicamentDoseEditText: TextInputEditText,
    ...
    fun measureCheckingEnableSaveButton(
        measureEditText: EditText,
        btnSave: MaterialButton
    ) {
        measureEditText.doAfterTextChanged {
            btnSave.isEnabled =
                measureEditText.text.toString().length in 2..5
        }
    }
}
